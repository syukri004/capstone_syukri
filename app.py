...
def get_average_durations(conn):
    ...
    result = selected_query.pivot_table(index='id',values = 'duration_minutes',aggfunc='mean').sort_values('duration_minutes',ascending=False).head()
    return result
